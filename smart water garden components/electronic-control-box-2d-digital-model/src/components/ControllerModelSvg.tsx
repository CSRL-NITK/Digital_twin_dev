...
export const ControllerModelSvg: React.FC<ControllerModelSvgProps> = ({
  ...
  return (
    <div className="relative w-full h-full flex items-center justify-center overflow-hidden select-none">
      <svg
        viewBox="0 0 500 620"
        className="w-full h-full max-h-[82vh] drop-shadow-xl transition-transform duration-200 ease-out"
        style={{
      ...
      >
        ...
        {/* BACKGROUND MOUNTING POLE (Left support structure) */}
        ...
        >
          {/* Upper attachment block beneath enclosure */}
          <path
          ...
          {isHighlighted('mounting-bracket') && (
            <path
              d="M 188 448 L 312 448 L 312 600 L 188 600 Z"
              fill="none"
              stroke="#00E5FF"
              strokeWidth="2.5"
              strokeDasharray="5,5"
        ...
        >
          ...
          {/* Cable Entry Gland Seal */}
          <rect x="232" y="70" width="26" height="15" rx="3" fill="#505A69" stroke="#333" strokeWidth="1" />
          {isHighlighted('top-conduit') && (
            <rect x="230" y="0" width="30" height="85" fill="none" stroke="#00E5FF" strokeWidth="2" strokeDasharray="4,4" />
          )}
        </g>
        ...
        >
          ...
          {isHighlighted('bottom-cable') && (
            <path
              d="M 280 435 L 280 500 C 280 540 270 570 260 620"
              fill="none"
              stroke="#00E5FF"
              strokeWidth="20"
              strokeOpacity="0.4"
        ...
        >
          ...
          {/* Lower Terminal Connector Array */}
          <g id="lower-terminal">
          ...
          {isHighlighted('pcb-base') && (
            <rect x="123" y="103" width="254" height="324" rx="10" fill="none" stroke="#00E5FF" strokeWidth="2" strokeDasharray="4,4" />
          )}
        </g>

        {/* BLUE RELAY MODULES */}
        {/* Main Central Blue Relay */}
        <g
        ...
        >
          ...
          {isHighlighted('main-relay-module') && (
            <rect x="213" y="136" width="76" height="72" rx="6" fill="none" stroke="#00E5FF" strokeWidth="2.5" />
          )}
        </g>

        {/* Auxiliary Blue Relay (Right) */}
        <g
        ...
        >
          ...
          {isHighlighted('secondary-relay-module') && (
            <rect x="296" y="186" width="62" height="66" rx="6" fill="none" stroke="#00E5FF" strokeWidth="2.5" />
          )}
        </g>

        {/* REFLECTED RED LIGHT ON SURROUNDING COMPONENTS */}
        <circle cx="251" cy="222" r="85" fill="url(#red-reflection-grad)" pointerEvents="none" />

        {/* WIRING HARNESS (Matching Reference Routing) */}
        <g
          id="wiring-harness"
          className="cursor-pointer"
        ...
        >
          ...
          {/* YELLOW WIRES (Center fan loops dropping down & curving right) */}
          <path
          ...
          {isHighlighted('wiring-harness') && (
            <g stroke="#00E5FF" strokeWidth="7" opacity="0.5" fill="none">
              <path d="M 210 392 C 160 380 145 310 165 260 C 180 220 215 210 225 195" />
              <path d="M 242 121 C 242 160 235 220 235 270 C 235 320 220 370 234 392" />
              <path d="M 330 248 C 340 280 335 330 300 365 C 290 375 285 385 282 392" />
            </g>
          )}
        </g>

        {/* GLOWING INDICATOR LEDs */}
        {/* RED LED (Upper Center) */}
        <g
          id="red-led"
          className="cursor-pointer"
        ...
        >
          ...
          <circle
            ...
            strokeWidth="0.8"
          />
          {/* Intense Specular Center Core */}
          <circle cx="250" cy="220" r="2.5" fill="#FFFFFF" opacity={0.9 * redGlowOpacity} />

          {isHighlighted('red-led') && (
            <circle cx="251" cy="222" r="16" fill="none" stroke="#00E5FF" strokeWidth="2" strokeDasharray="3,3" />
          )}
        </g>

        {/* AMBER / YELLOW LED (Directly Below Red LED) */}
        <g
          id="amber-led"
          className="cursor-pointer"
        ...
        >
          ...
          {isHighlighted('amber-led') && (
            <rect x="240" y="246" width="22" height="18" rx="3" fill="none" stroke="#00E5FF" strokeWidth="2" strokeDasharray="3,3" />
          )}
        </g>
        ...
        {activeMode !== 'xray' && (
          <g id="enclosure-lid" pointerEvents="none" style={{ opacity: lidOpacity }}>
            {/* Clear Translucent Polycarbonate Shield */}
            <rect
              x="116"
              y="96"
              width="268"
              ...
              strokeWidth="2"
            />
            {/* Specular Diagonal Reflection Sheen Lines */}
            <path
