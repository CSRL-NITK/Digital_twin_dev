...
export function SolarPanelNodeView({ id, data, selected }: NodeProps<any>) {
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-[84%] left-1/2 -translate-x-1/2 whitespace-nowrap bg-slate-800 border border-slate-700 text-slate-200 text-xs font-bold px-3 py-1 rounded shadow pointer-events-none z-50">
        {nodeName}
      </div>
    </div>
  );
